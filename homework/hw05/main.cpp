...
void displayHighScores(SortedListInterface<int>* listPtr)
{
...
int main()
{
	...
	scoreList->insertSorted(80000);
	scoreList->insertSorted(50000);
	scoreList->insertSorted(25000);
	
	while (score >= 0)
	{
		cout << "Enter the " + next + "high score: ";
		cin >> score;
